package com.louyj.cottus.model.http;
...
import com.louyj.cottus.model.config.IConfigListener;
import com.louyj.cottus.model.message.BaseMessage;
import com.louyj.cottus.model.message.RejectMessage;
import com.louyj.cottus.model.message.consts.CustomHeaders;
import com.louyj.cottus.model.message.consts.EncryptType;
import com.louyj.cottus.model.message.consts.RejectReason;
import com.louyj.cottus.model.util.AESEncryptUtils;
import com.louyj.cottus.model.util.JsonUtils;
import com.louyj.cottus.model.util.RsaUtils;
...
public class MessageExchanger implements InitializingBean, DisposableBean, IConfigListener {
	...
	public final BaseMessage jsonPost(String endpoint, BaseMessage message) {
		...
		return RejectMessage.creason(message.getClientId(), message.getExchangeId(),
				"[" + RejectReason.CLIENT_ERROR.reason() + "] All servers not available");
	}
	...
	private final BaseMessage jsonPostOnce(String endpoint, BaseMessage message) {
		try {
			...
			return RejectMessage.creason(message.getClientId(), message.getExchangeId(),
					"[" + RejectReason.CLIENT_ERROR.reason() + "]" + e.getClass().getSimpleName() + ":" + e.getMessage());
		}
	}
