...
public class HandlerCommand extends BaseCommand {
	...
	public String handlers() {
		ListHandlersMessage message = new ListHandlersMessage(ClientDetector.CLIENT);
	...
	public String handlerDescribe(@ShellOption(value = { "-n", "--name" }, help = "handler name") String name) {
		DescribeHandlerMessage message = new DescribeHandlerMessage(ClientDetector.CLIENT);
