...
public class ExtendedDefaultParser implements Parser {
	...
	/**
	 * Returns true if the specified character is a whitespace parameter. Check to
	 * ensure that the character is not escaped by any of {@link #getQuoteChars},
	 * and is not escaped by ant of the {@link #getEscapeChars}, and returns true
	 * from {@link #isDelimiterChar}.
	 *
	...
	/**
	 * Check if this character is a valid escape char (i.e. one that has not been
	 * escaped)
	 */
	 ...
	 * @return true if the character at the specified position in the given buffer
	 *         is an escape character and the character immediately preceding it is
	...
	/**
	 * Returns true if the character at the specified position if a delimiter. This
	 * method will only be called if the character is not enclosed in any of the
	 * {@link #getQuoteChars}, and is not escaped by ant of the
	 * {@link #getEscapeChars}. To perform escaping manually, override
	 * {@link #isDelimiter} instead.
	 */
