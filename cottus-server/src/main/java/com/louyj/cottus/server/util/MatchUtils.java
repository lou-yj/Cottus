package com.louyj.cottus.server.util;
...
public class MatchUtils {
	...
	public static boolean isWindowMatched(boolean regexMatch, List<Map<String, Object>> sourceMapWin,
		...
		for (Entry<String, Object> entry : matchedCond.entrySet()) {
			String matchedKey = PlaceHolderUtils.replacePlaceHolder(envDc, entry.getKey());
			Object matchedValue = PlaceHolderUtils.replacePlaceHolder(envDc, entry.getValue());
	...
	public static boolean isMatched(boolean regexMatch, Map<String, Object> sourceMap, Map<String, Object> matchedCond,
		...
		for (Entry<String, Object> entry : matchedCond.entrySet()) {
			String key = PlaceHolderUtils.replacePlaceHolder(envDc, entry.getKey());
			Object expect = PlaceHolderUtils.replacePlaceHolder(envDc, entry.getValue());
